...
hdfs dfs -mkdir -p jsvirzi/mr2b/in
...
for debugging, edit demo2b.sh and use the python / hadoop line that does not
output to /dev/null. There will be lots of output to the screen.

for production, edit demo2b.sh and use the python / hadoop line that outputs
to /dev/null to suppress the tons of output

to insert the table into hbase, use "hive -f mr2b_to_hbase.q "
